    ...
    <div className="bg-slate-700 dark:slate-500 border-b border-nav-border">
      <div
        ...
        <div className="flex items-center gap-1">
          ...
          {/* Cart */}
          <button className="p-2 hover:text-accent transition-colors text-muted-foreground relative">
            <ShoppingCart className="w-4 h-4 text-slate-200 dark:text-slate-300" />
          </button>
        </div>
      </div>
    </div>);
