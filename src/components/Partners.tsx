  ...
  return (
    <section className="py-16 bg-background">
      ...
      <div
        ...
        <div
          key={i}
          className="flex-shrink-0 w-[180px] h-[100px] flex items-center justify-center bg-slate-100 dark:bg-slate-700/50 rounded-lg p-4 border-border px-[4px] py-[4px] border-0 shadow-md">
