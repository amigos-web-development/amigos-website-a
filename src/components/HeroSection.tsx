        ...
        <div className="container mx-auto px-4" style={{ maxWidth: "80%" }}>
          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a
                href="#"
                className="px-6 py-3 border-2 border-slate-200/5 hover:border-slate-800/50 hover:bg-[linear-gradient(135deg,_#222,_#444,_#555)] text-slate-200 font-semibold rounded-lg transition-all duration-300"
              >
                View Products
              </a>
            </div>
