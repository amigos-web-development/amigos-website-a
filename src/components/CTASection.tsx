      ...
      <div className="container mx-auto px-4" style={{ maxWidth: "80%" }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {ctaItems.map((item) => (
            <div
              key={item.title}
              className="border bg-slate-100 dark:bg-slate-700 rounded-xl shadow-lg p-8 text-center transition-all duration-300 group cursor-pointer"
            >
              ...
              <a
                href="#"
                className="inline-block px-6 py-3 bg-[linear-gradient(135deg,_#222,_#444,_#555)] hover:bg-[linear-gradient(135deg,_#1d4ed8,_#dc2626,_#f97316)] text-slate-200 font-semibold rounded-lg transition-all duration-300"
              >
                {item.buttonText}
              </a>
            </div>
