    ...
    <section className="py-20 category-gradient">
      <div className="container mx-auto px-4" style={{ maxWidth: "80%" }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div
            key={item.title}
            className="bg-slate-100/70 dark:bg-slate-700/70 border border-white/20 rounded-xl p-8 text-center hover:bg-slate-200/50 dark:hover:bg-slate-600/50 transition-all duration-300 group">
